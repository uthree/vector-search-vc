...
class VoiceConvertorWrapper():
    ...
    def convert_features(self, features, speaker, k=4):
        features = features[0]
        # [768, length]
    ...
    def convert(self, wave, speaker, f0_rate=1.0, k=4):
        index = speaker.index
        with torch.no_grad():
            if wave.ndim == 2:
                wave = wave[0]
            ...
            hubert_features = self.convert_features(hubert_features, speaker, k)
